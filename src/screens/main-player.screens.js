...
class MainPlayerScreen extends React.Component {
    ...
    AsyncStorage.multiGet([
      ...
      if (storedData) {
        ...
        AsyncStorage.setItem(
          CommonConstants.PERSISTENT_STORAGE_KEY.RECENT_TUTORIALS,
          JSON.stringify(recentTutorials)
        );
  ...
  shouldComponentUpdate(nextProps, nextState) {
    if (
      nextProps.wishlist_changed &&
      this.state.wishlist_changed != nextProps.wishlist_changed
    ) {
  ...
  render() {
    ...
    if (item && item.description) {
      tutorial_description_p_count = (item.description.match(/<\/p>/g) || [])
        .length;

      tutorial_description_p_count += (item.description.match(/<br \/>/g) || [])
        .length;

      tutorial_description_p_count += (item.description.match(/<\/li>/g) || [])
        .length;
    }

    const webviewHeight =
      (i18n.language == "en" ? 40 : 80) *
        (item.description.length / finalWidth) +
      (i18n.language == "en" ? 60 : 100) * tutorial_description_p_count;
      ...
      <NativeBaseProvider>
        <SafeAreaView
          style={{
            ...
            height: this.orientation == "PORTRAIT" ? statusBarCurrentHeight : 0,
          }}
        />
        ...
        <Box
          style={
            (COMMON_STYLES.SAFE_AREA_SECTION,
            {
              flex: 1,
              paddingTop:
                Platform.OS == "android" && this.orientation == "LANDSCAPE"
        ...
        >
          ...
          <ImageBackground
            ...
            style={{
              ...
              height:
                this.orientation == "PORTRAIT" ? portraitVideoHeight : "100%",
            }}
            imageStyle={{
            ...
            {this.orientation == "PORTRAIT" && (
              ...
              >
                <VideoPlayer
                  ...
                  disableVolume={true}
                  resizeMode={
                    this.orientation == "PORTRAIT" ? "contain" : "contain"
                  }
                  controls={false}
                  navigator={false}
            ...
            {this.orientation == "PORTRAIT" && (
              ...
              >
                <ScrollView>
                        ...
                        >
                          ...
                          {item.is_favourting_in_progress == false &&
                            !item.favourited_info && (
                              <TouchableOpacity
                                onPress={this._onClickedFavourite}
                                style={{
                                  width: 30,
                                  height: 30,
                                  justifyContent: "center",
                          ...
                          {item.is_favourting_in_progress == false &&
                            ...
                            item.favourited_info._id && (
                              <TouchableOpacity
                                onPress={this._onClickedUnfavourite}
                                style={{
                                  width: 30,
                                  height: 30,
                                  justifyContent: "center",
                  ...
                  {item &&
                    ...
                    item.description != "" && (
                      <WebView
                        ...
                        source={{
                          html:
                            '<html><head><meta http-equiv="content-type" content="text/html; charset=utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no"><style media="screen" type="text/css">@font-face{font-family:"Zawgyi-One";src:url("' +
                            zawgyiOnefontUrl +
                            '")} @font-face{font-family:"Pyidaungsu-Regular";src:url("' +
                            pyidaungsufontUrl +
                            '")} @font-face{font-family:"RobotoMono-Regular";src:url("' +
                            robotomonoRegularfontUrl +
                  ...
                  {item &&
                    item.tutorial_summary_pdf_file &&
                    item.tutorial_summary_pdf_file != false &&
                    item.tutorial_summary_pdf_file != "" && (
                      <Box
                        style={{
                          borderBottomWidth: 0,
    ...
    if (Platform.OS == "android") {
      ...
      Share.shareSingle(shareOptions).catch(() => {
        this.modalAlert = {
          ...
          description: t(
            "Unable to share the tutorial. Please contact support team"
          ),
        };
        this.setState({
          forceRender: !this.state.forceRender,
  ...
  _onClickedFavourite = () => {
    ...
    this.digiedModule
      ...
      .then((response) => {
        ...
        this.props.item.total_favourited_count =
          response.data.total_favourited_count;
        this.props.item.total_favourited_count_display =
        ...
        AsyncStorage.multiGet([
          ...
          .then((storedData) => {
            if (
              ...
              AsyncStorage.setItem(
                CommonConstants.PERSISTENT_STORAGE_KEY.RECENT_TUTORIALS,
                JSON.stringify(recent_tutorials)
              );
            }
...
export default withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(MainPlayerScreen)
);
