...
class ProfileScreen extends React.PureComponent {
  ...
  load = (forceRefresh) => {
    ...
    this.userModule
      .getProfile({ userId: this.LOGGEDIN_USER.id })
      .then((response) => {
              ...
              <ScrollView>
                              ...
                              this.setState(
                                ...
                                () => {
                                  this.modalAlert = {
                                    ...
                                    description:
                                      "Uploading profile photo failed",
                                  };
                                  this.setState({
                                    forceRender: !this.state.forceRender,
                                  });
                ...
                <Box
                  style={{
                    ...
                    height:
                      height > 740
                        ? height - (210 + statusBarCurrentHeight)
                        : "100%",
                    flex: 1,
                  }}
                >
                        ...
                        <Col>
                          ...
                          >
                            ...
                            <Select
                              ...
                              style={[COMMON_STYLES[i18n.language].input]}
                              maxWidth={250}
                              selectedValue={user.language}
                              onValueChange={this._onLanguageValueChange.bind(
                                this
                              )}
                            >
                              <Select.Item
                              ...
                              <Select.Item
                                key="mm"
                                label={t("Myanmar Unicode")}
                                value="mm"
                              />
                              <Select.Item
                                key="zg"
                                label={t("Myanmar Zawgyi")}
                                value="zg"
                              />
                            </Select>
                          </Box>
                  ...
                  >
                    <Grid>
                      ...
                      >
                        <TouchableOpacity
                          onPress={this._onClickedUpdateProfile}
                        >
                          <Box
                            style={{
            ...
            setTimeout(() => {
              if (
                ...
                this.modalAlert = {
                  ...
                  title: t("Update Profile Failed"),
                  description: t(
                    "Unable to update your profile. Please contact support team"
                  ),
                };
                this.setState({
                  forceRender: !this.state.forceRender,
