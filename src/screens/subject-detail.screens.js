    ...
    this.digiedModule
      ...
      .then((response) => {
        ...
        _.each(response.data.data, (data, index) => {
          ...
          if (
            i18n.language != "en" &&
            data.chapter_no_l10n &&
            data.chapter_no_l10n[i18n.language]
          ) {
          ...
          if (
            i18n.language != "en" &&
            data.chapter_title_l10n &&
            data.chapter_title_l10n[i18n.language]
          ) {
          ...
          if (data.subject) {
            ...
            if (
              i18n.language != "en" &&
              data.subject.subject_name_l10n &&
              data.subject.subject_name_l10n[i18n.language]
            ) {
            ...
            if (data.subject.subject_cover_image) {
              chapter.subject.cover_image = {
                uri:
                  CommonConstants.storage_endpoint +
                  "/" +
                  data.subject.subject_cover_image,
              };
            } else {
            ...
            if (data.subject.course) {
              ...
              if (
                i18n.language != "en" &&
                data.subject.course.course_name_l10n &&
                data.subject.course.course_name_l10n[i18n.language]
              ) {
              ...
              <Fragment>
                ...
                >
                  {selectedSubject.subject_banner_image && (
                    <FastImage
                      source={selectedSubject.subject_banner_image}
                      style={{
                        width: width - 20,
                        height: theCoverImageHeight,
                        marginLeft: "auto",
...
export default withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(SubjectDetailScreen)
);
