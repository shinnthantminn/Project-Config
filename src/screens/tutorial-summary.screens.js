              ...
              {item && item.summary && (
                ...
                >
                  <WebView
                    ...
                    source={{
                      html:
                        '<html><head><meta http-equiv="content-type" content="text/html; charset=utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no"><style media="screen" type="text/css">*{margin:0;padding:0;font-family:' +
                        (i18n.language == "en" ? "Arial_MT" : "Pyidaungsu") +
                        ";font-size:20px;color:#ffffff;}</style></head><body>" +
                        item.summary +
                        "</body></html>",
                    }}
                    style={{
