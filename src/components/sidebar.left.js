          ...
          >
                  ...
                  >
                    ...
                    <TouchableOpacity onPress={this._onClickedHome}>
                      <Text
                        ...
                        numberOfLines={1}
                      >
                        {CommonConstants.app_name_short}
                      </Text>
                    </TouchableOpacity>
                  </Box>
                </Col>
            ...
            >
              <Box style={styles.item}>
                <TouchableOpacity
                  onPress={() => this._onClickedActions("home")}
                >
                  <Box
                    style={{
                      flexDirection: "row",
              ...
              <Box style={styles.item}>
                <TouchableOpacity
                  onPress={() => this._onClickedActions("newsfeed")}
                >
                  <Box
                    style={{
                      flexDirection: "row",
              ...
              <Box style={styles.item}>
                <TouchableOpacity
                  onPress={() => this._onClickedActions("notification")}
                >
                  <Box
                    style={{
                      flexDirection: "row",
                    ...
                    >
                      ...
                      {global.total_unread_notification_count > 0 && (
                        ...
                        >
                          ...
                          >
                            {global.total_unread_notification_count}
                          </Text>
                        </Box>
                      )}
                    </Box>
              ...
              <Box style={styles.item}>
                <TouchableOpacity
                  onPress={() => this._onClickedActions("technical-support")}
                >
                  <Box
                    style={{
                      flexDirection: "row",
              ...
              <Box style={styles.item}>
                <TouchableOpacity
                  onPress={() => this._onClickedActions("logout")}
                >
                  <Box
                    style={{
                      flexDirection: "row",
              ...
              <Box style={styles.item}>
                ...
                >
                  ...
                  >
                    {t("Version")} {CommonConstants.version}
                  </Text>
                </Box>
              </Box>
            </Box>
      ...
      Linking.canOpenURL("fb-messenger://")
        .then((supported) => {
          if (!supported) {
            ...
            Linking.openURL(
              "https://m.me/" +
                CommonConstants.TECHNICAL_SUPPORT_FB_MESSENGER_ID
            );
          } else {
            Linking.openURL(
        ...
        .catch((err) => {
          Linking.openURL(
            "https://m.me/" + CommonConstants.TECHNICAL_SUPPORT_FB_MESSENGER_ID
          );
        });
