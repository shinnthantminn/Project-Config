  ...
  AsyncStorage.multiGet([
    ...
    .then((storedData) => {
      if (storedData) {
        ...
        if (
          !storedData[3] ||
          (storedData[3] && storedData[3][1] == null) ||
          (LOGGEDIN_USER &&
            storedData[3] &&
            storedData[3][1] != LOGGEDIN_USER.id.toString()) ||
          (!LOGGEDIN_USER &&
            storedData[3] &&
            storedData[3][1] != "tracked_once")
        ) {
                  ...
                  .then((message) => {
                    if (message) {
                      ...
                      if (
                        ...
                        message.data.tutorial_id
                      ) {
                        // get tutorial info
                        digiedModule
                          .getTutorialsByIds({
                            page: "all",
                            ids: message.data.tutorial_id,
                          })
                          .then((response) => {
                            ...
                            if (
                              ...
                              if (
                                ...
                                data.tutorial_title_l10n[language]
                              ) {
                                tutorial.title =
                                  data.tutorial_title_l10n[language];
                                tutorial.tutorial_title_l10n =
                                  data.tutorial_title_l10n;
                              }
                              ...
                              if (
                                ...
                                data.tutorial_description_l10n[language]
                              ) {
                                tutorial.description =
                                  data.tutorial_description_l10n[language];
                                tutorial.tutorial_description_l10n =
                                  data.tutorial_description_l10n;
                              }
                              ...
                              if (data.chapter) {
                                ...
                                tutorial.chapter_no_en =
                                  data.chapter.chapter_no;

                                if (
                                  language != "en" &&
                                  data.chapter.chapter_no_l10n &&
                                  data.chapter.chapter_no_l10n[language]
                                ) {
                                  tutorial.chapter_no =
                                    data.chapter.chapter_no_l10n[language];
                                  tutorial.chapter_no_l10n =
                                    data.chapter.chapter_no_l10n;
                                }

                                tutorial.chapter_title =
                                  data.chapter.chapter_title;
                                tutorial.chapter_title_en =
                                  data.chapter.chapter_title;

                                if (
                                  language != "en" &&
                                  data.chapter.chapter_title_l10n &&
                                  data.chapter.chapter_title_l10n[language]
                                ) {
                                  tutorial.chapter_title =
                                    data.chapter.chapter_title_l10n[language];
                                  tutorial.chapter_title_l10n =
                                    data.chapter.chapter_title_l10n;
                                }

                                if (data.chapter.subject) {
                                  tutorial.subject_title =
                                    data.chapter.subject.subject_name;
                                  tutorial.subject_title_en =
                                    data.chapter.subject.subject_name;
                                  ...
                                  if (data.chapter.subject.course) {
                                    ...
                                    if (
                                      language != "en" &&
                                      data.chapter.subject.course
                                        .course_name_l10n &&
                                      data.chapter.subject.course
                                        .course_name_l10n[language]
                                    ) {
                                      tutorial.course_title =
                                    ...
                                    if (
                                      ...
                                      if (
                                        ...
                                        data.chapter.subject.course
                                          .course_category
                                          .course_category_name_l10n[language]
                                      ) {
                                        tutorial.course_category_title =
                              ...
                              tutorial.favourited_info = _.find(
                                ...
                                (favourited_tutorial) => {
                                  return (
                                    favourited_tutorial.tutorial_id == data.id
                                  );
                                }
                              );
                              ...
                              digiedModule
                                .getNotifications({
                                  ids: message.data.notification_id,
                                  page: 1,
                                  per_page: 1,
                                })
                                .then((response) => {
                                  ...
                                  if (
                                    language != "en" &&
                                    data.content_l10n &&
                                    data.content_l10n[language]
                                  ) {
                                    notification.content =
                                      data.content_l10n[language];
                                  }

                                  notification.tutorial = _.find(
                                  ...
                                  if (notification.tutorial) {
                                    notification.tutorial.tutorial_title =
                                      notification.tutorial.tutorial_title;
                                    ...
                                    if (
                                      ...
                                      notification.tutorial
                                        .tutorial_title_l10n &&
                                      notification.tutorial.tutorial_title_l10n[
                                        language
                                      ]
                                    ) {
                                      notification.tutorial.tutorial_title =
